...
void equipments (Configs *c, Character *Takeshi)
{
    ...
    if (strcmp (c->language, "PT-BR") == 0)
    {
        printf ("\n*---Armadura do Tigre de Kōzuke: %s---*", Takeshi->tiger == 1 ? "Equipar" : "Não Possuído");
        printf ("\n*---Armadura da Fênix Imortal: %s---*", Takeshi->fenix == 1 ? "Equipar" : "Não Possuído");
        printf ("\n*---Armadura do Dragão Celestial: %s---*\n", Takeshi->dragon == 1 ? "Equipar" : "Não Possuído");
    
        printf ("\n*----------------------------------*");
        printf ("\n| 1 - ARMADURA DO TIGRE DE KŌZUKE  |");
        printf ("\n*----------------------------------*");
        printf ("\n| 2 - ARMADURA DA FÊNIX IMORTAL    |");
        printf ("\n*----------------------------------*");
        printf ("\n| 3 - ARMADURA DO DRAGÃO CELESTIAL |");
        printf ("\n*----------------------------------*");
        printf ("\n| 4 - SAIR                         |");
        printf ("\n*----------------------------------*");
