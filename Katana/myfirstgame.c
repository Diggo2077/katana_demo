...
void showAttributes (Configs *c, Character *Takeshi)
{
    ...
    if (strcmp (c->language, "PT-BR") == 0)
    {
        ...
        printf ("\n*----------------------------------------*");
        printf ("\n|               Nível: %02d                |", Takeshi->level);
        printf ("\n*----------------------------------------*");
        printf ("\n|         Experiência: %06d            |", Takeshi->xp);
        printf ("\n*----------------------------------------*");
        printf ("\n| Pontos de Habilidades Disponíveis: %02d  |", Takeshi->attributes);
        printf ("\n*----------------------------------------*\n");
    
        printf ("\n*-----------------------*");
        printf ("\n| Vida: %03d - %02d        |", Takeshi->health * 10, Takeshi->bonus_hp);
        printf ("\n*-----------------------*");
        printf ("\n| Ataque: %03d + %02d      |", Takeshi->attack, Takeshi->bonus_ttk);
        printf ("\n*-----------------------*");
        printf ("\n| Defesa: %03d           |", Takeshi->defense);
        printf ("\n*-----------------------*");
        printf ("\n| Resistência: %03d - %02d |", Takeshi->stamina * 5, Takeshi->bonus_sta);
        printf ("\n*-----------------------*\n");
    ...
    else
    {
        ...
        printf ("\n*-------------------*");
        printf ("\n| Health: %03d - %02d  |", Takeshi->health * 10, Takeshi->bonus_hp);
        printf ("\n*-------------------*");
        printf ("\n| Attack: %03d + %02d  |", Takeshi->attack, Takeshi->bonus);
        printf ("\n*-------------------*");
        printf ("\n| Defense: %03d         |", Takeshi->defense);
        printf ("\n*-------------------*");
        printf ("\n| Stamina: %03d - %02d |", Takeshi->stamina * 5, Takeshi->bonus_sta);
        printf ("\n*-------------------*\n");
...
void equipments (Configs *c, Character *Takeshi)
{
    int choice;

    if (strcmp (c->language, "PT-BR") == 0)
    {
        printf ("\n*---Gi: %s---*", Takeshi->gi.armor == 1 ? "Equipado" : "Equipar");
        printf ("\n*---Armadura do Tigre de Kōzuke: %s---*", Takeshi->tiger == 1 ? "Equipado" : "Equipar");
        printf ("\n*---Armadura da Fênix Imortal: %s---*", Takeshi->fenix == 1 ? "Equipado" : "Equipar");
        printf ("\n*---Armadura do Dragão Celestial: %s---*\n", Takeshi->dragon == 1 ? "Equipado" : "Equipar");
        ...
        {
            case 1:
                if (Takeshi->gi.armor != 1)
                {
                    printf ("\n\n===> Gi equipado com sucesso! <===\n\n");
                    Takeshi->gi = changeEquip (&Takeshi->gi, choice);
                }
                else
                {
                    printf ("\n\n===> Gi já equipado <===\n\n");
                ...
                break;
            case 2:
                if (Takeshi->tiger == 1 && Takeshi->gi.armor != 2)
                {
                    printf ("\n\n===> Armadura do Tigre de Kōzuke equipado com sucesso! <===\n\n");
                    Takeshi->gi = changeEquip (&Takeshi->gi, choice);
                }
                else if (Takeshi->tiger == 1 && Takeshi->gi.armor == 2)
                {
                ...
                break;
            case 3:
                if (Takeshi->fenix == 1 && Takeshi->gi.armor != 3)
                {
                    printf ("\n\n===> Armadura da Fênix Imortal equipado com sucesso! <===\n\n");
                    Takeshi->gi = changeEquip (&Takeshi->gi, choice);
                }
                else if (Takeshi->fenix == 1 && Takeshi->gi.armor == 3)
                {
                    printf ("\n\n===> Armadura já equipada <===");
                }
                else
                ...
                break;
            case 4:
                if (Takeshi->dragon == 1 && Takeshi->gi.armor != 4)
                {
                    printf ("\n\n===> Armadura do Dragão Celestial equipado com sucesso! <===\n\n");
                    Takeshi->gi = changeEquip (&Takeshi->gi, choice);
                }
                else if (Takeshi->dragon == 1 && Takeshi->gi.armor == 4)
                {
                    printf ("\n\n===> Armadura já equipada <===");
                }
                else
    ...
    {
        printf ("\n*---Gi: %s---*", Takeshi->gi.armor == 1 ? "Equipped" : "Equip");
        printf ("\n*---Kōzuke's Tiger Armor: %s---*", Takeshi->tiger == 1 ? "Equipped" : "Equip");
        printf ("\n*---Immortal Phoenix Armor: %s---*", Takeshi->fenix == 1 ? "Equipped" : "Equip");
        printf ("\n*---Celestial Dragon Armor: %s---*\n", Takeshi->dragon == 1 ? "Equipped" : "Equip");
...
void inventory (Configs *c, Character *Takeshi)
{
    ...
    if (strcmp (c->language, "PT-BR") == 0)
    {
        ...
        printf ("\n*----------------------------------*");
        printf ("\n| Pílulas de Ginseng: %d/3          |", Takeshi->ginseng);
        printf ("\n*----------------------------------*");
        printf ("\n| Elixir da Cura do Imperador: %d/1 |", Takeshi->elixir);
        printf ("\n*----------------------------------*");
        printf ("\n| Saquê de Fogo do Dragão: %d/1     |", Takeshi->sake);
        printf ("\n*----------------------------------*\n");
        ...
        {
        case 1:
            if (Takeshi->ginseng == 0) printf ("\n\n*---PÍLULAS INSUFICIENTES---*\n\n");
            else if (Takeshi->bonus_hp >= 50) printf ("\n\n*---ENERGIA MÁXIMA---*\n\n");
            else 
            {
                Takeshi->ginseng -= 1;
                Takeshi->bonus_hp += 50;
                if (Takeshi->bonus_hp >= 50) Takeshi->bonus_hp = 50;
                printf ("\n\n*---BÔNUS DE VIDA = %d---*", Takeshi->bonus_hp);
                printf ("\n\n===>-1 PÍLULAS DE GINSENG<===\n\n");
            }
            break;
        ...
        case 2:
            ...
            if (Takeshi->elixir == 0) printf ("\n\n*---ELIXIR INSUFICIENTE---*\n\n");
            else if (Takeshi->bonus_sta >= 50) printf ("\n\n*---ENERGIA MÁXIMA---*\n\n");
            else {
                Takeshi->elixir -= 1;
                Takeshi->bonus_sta += 50;
                if (Takeshi->bonus_sta >= 50) Takeshi->bonus_sta = 50;
                printf ("\n\n*---BÔNUS DE RESISTÊNCIA = %d---*", Takeshi->bonus_sta);
                printf ("\n\n===>-1 ELIXIR DA CURA DO IMPERADOR<===\n\n");
            }
            break;

        case 3:
            if (Takeshi->sake == 0) printf ("\n\n*---SAQUÊS INSUFICIENTES---*\n\n");
            else if (Takeshi->bonus_ttk >= 5) printf ("\n\n*---EFEITO MÁXIMO ALCANÇADO---*\n\n");
            else {
                Takeshi->sake += 1;
                Takeshi->bonus_ttk += 5;
                printf ("\n\n*---BÔNUS DE ATAQUE = %d---*", Takeshi->bonus_ttk);
    ...
    else
    {
        ...
        printf ("\n*-------------------------------*");
        printf ("\n| Ginseng Pills: %d/3            |", Takeshi->ginseng);
        printf ("\n*----------------------------------*");
        printf ("\n| Emperor's Healing Elixir: %d/1 |", Takeshi->elixir);
        printf ("\n*----------------------------------*");
        printf ("\n| Dragon Fire Sake: %d/1         |", Takeshi->sake);
        printf ("\n*----------------------------------*\n");
        ...
        case 2:
            ...
            if (Takeshi->elixir == 0) printf ("\n\n*---INSUFFICIENT ELIXIR---*\n\n");
                ...
                Takeshi->bonus_sta += 50;
                if (Takeshi->bonus_sta >= 50) Takeshi->bonus_sta = 50;
                printf ("\n\n*---RESISTANCE BONUS = %d---*", Takeshi->bonus_sta);
        ...
        case 3:
            if (Takeshi->sake == 0) printf ("\n\n*---INSUFFICIENT SAKES---*\n\n");
                ...
                Takeshi->sake += 1;
                Takeshi->bonus_ttk += 5;
                printf ("\n\n*---ATTACK BONUS = %d---*", Takeshi->bonus_ttk);
                printf ("\n\n===>-1 DRAGON FIRE SAKE<===\n\n");
            }
            break;
        case 4:
